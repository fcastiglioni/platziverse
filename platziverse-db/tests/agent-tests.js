...
test.serial('Setup', t => {
  ...
  t.true(MetricStub.belongsTo.called, 'MetricModel.belongsTo was executes')
...
test.serial('Agent#findAll', async t => {
  ...
  t.is(agents.length, agentFixtures.all.length, 'agent should be the same')
...
test.serial('Agent#findByUsername', async t => {
  ...
  t.true(AgentStub.findAll.called, 'findAll should be called on model')
  t.true(AgentStub.findAll.calledOnce, 'findAll should be called once')
  t.true(AgentStub.findAll.calledWith(usernameArgs), 'findAll should be called withusername args')

  t.is(agents.length, agentFixtures.platzi.length, 'agent should be the same')
...
test.serial('Agent#findConnected', async t => {
  ...
  t.is(agents.length, agentFixtures.connected.length, 'agent should be the same')
